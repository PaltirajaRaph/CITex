        ...
        <nav class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="ibda_iee.php?topic=Web Programming">Web Programming</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="ibda_iee.php?topic=Microcontrollers">Microcontrollers</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="ibda_iee.php?topic=Object Oriented Programming">Object Oriented Programming</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="ibda_iee.php?topic=System Database">System Database</a>
                    </li>
                </ul>
            </div>
        </nav>
