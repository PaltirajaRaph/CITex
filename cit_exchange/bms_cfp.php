    ...
    <nav class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
        <div class="sidebar-sticky">
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link active" href="bms_cfp.php?topic=Genomics">Genomics</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="bms_cfp.php?topic=Biotechnology">Biotechnology</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="bms_cfp.php?topic=Nutrition">Nutrition</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="bms_cfp.php?topic=Food Processing">Food Processing</a>
                </li>
            </ul>
        </div>
    </nav>
